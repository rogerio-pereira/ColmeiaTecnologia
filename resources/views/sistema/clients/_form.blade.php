...
<div class='col-md-6'>
    ...
    {!! Form::input('text', 'cpf_cnpj', null, ['class' => 'form-control cpf_cnpj', 'id' => 'cpf_cnpj']) !!}
</div>

<div class='col-md-6'>
    {!! Form::label('birthdate', 'Nascimento') !!}
    {!! Form::input('date', 'birthdate', null, ['class' => 'form-control date', 'id' => 'birthdate']) !!}
</div>

<div class='col-md-6'>
    {!! Form::label('phone', 'Telefone') !!}
    {!! Form::input('text', 'phone', null, ['class' => 'form-control phone', 'id' => 'phone']) !!}
</div>

<div class='col-md-6'>
    {!! Form::label('cellphone', 'Celular') !!}
    {!! Form::input('text', 'cellphone', null, ['class' => 'form-control phone', 'id' => 'cellphone']) !!}
</div>
...
<div class='col-md-6'>
    ...
    {!! Form::input('text', 'zipcode', null, ['class' => 'form-control zipcode', 'id' => 'zipcode']) !!}
</div>
...
<div class='col-md-6'>
    ...
    {!! Form::input('number', 'number', null, ['class' => 'form-control', 'id' => 'number', 'id' => 'number','min' => 1, 'step' => 1]) !!}
</div>
...
<div class='col-md-6'>
    ...
    {!! Form::input('text', 'neighborhood', null, ['class' => 'form-control', 'id' => 'neighborhood']) !!}
</div>

<div class='col-md-6'>
    {!! Form::label('city', 'Cidade') !!}
    {!! Form::input('text', 'city', null, ['class' => 'form-control', 'id' => 'city']) !!}
</div>
